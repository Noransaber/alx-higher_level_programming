...
Unittest classes:
    Test_Rect_instantiation
    Test_Rect_width
    Test_Rect_height
    Test_Rect_x
    Test_Rect_y
    Test_Rect_order_of_initialization
    Test_Recta_area
    Test_Rect_update_arg
    test_Rect_update_kwargs
    Test_rect_to_dictionary
"""
import io
import sys
import unittest
...
class TestRectangle_x(unittest.TestCase):
    """testing initialization for rectangle x attr."""
...
class TestRectangle_y(unittest.TestCase):
    """testing for init of ectangle y attr."""
...
class TestRectangle_area(unittest.TestCase):
    """testing for the area method of the Rectangle class."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for__str__ and display methods."""
